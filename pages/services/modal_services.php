        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" id="hidden_id" name="input[service_id]">
                    <div class="form-group row">
                        <div class="col">
                            <label><strong>Name</strong></label>
                            <div>
                            <input type="text" class="form-control input-item" name="input[service_name]" id="service_name" placeholder="Service Name" autocomplete="off" maxlength="100" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
