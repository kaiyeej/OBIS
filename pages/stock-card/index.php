                    ...
                    <form id='frm_generate'>
                        <div class="form-group row">
                            <div class="col">
                                ...
                                <div>
                                    <select class="form-control select2" id="product_category_id" name="input[product_category_id]" onchange="fetchProduct()">
                            ...
                            <div class="col">
                                ...
                                <div>
                                    <select class="form-control select2" id="product_id" name="input[product_id]">
                                        <option class="">&mdash; Please Select &mdash; </option>
                                    </select>
                                </div>
                            </div>
