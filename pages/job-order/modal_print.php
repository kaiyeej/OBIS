         ...
         <div class="modal-content">
             ...
             <div class="modal-body" style="padding: 15px;">
                 ...
                 <div class="col-12" id="print_canvas">
                     ...
                     <center><strong>Product: </strong><span id="product_name_span"></span></center>
                     <center><strong>No. of Batches: </strong><span id="no_of_batches_span"></span></center>
                     <center><strong>Date: </strong><span id="date_span"></span></center>
                     <center><strong>Reference: </strong><span id="reference_span"></span></center>
